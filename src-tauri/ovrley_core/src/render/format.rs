...
use crate::normalize::{
    ElapsedTimeOrigin, ValidatedGradientWidget, ValidatedTimeFormatting, ValidatedTimeValue,
    ValidatedValueFormatting, ValidatedValueWidget,
};
        ...
        ValidatedTimeFormatting::Elapsed {
            ...
            let (elapsed, total) = match origin {
                ElapsedTimeOrigin::Activity => {
                    (elapsed_time.activity_seconds, elapsed_time.activity_total_seconds)
                }
                ElapsedTimeOrigin::Export => {
                    (elapsed_time.export_seconds, elapsed_time.export_total_seconds)
                }
            };
